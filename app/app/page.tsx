  ...
  return (
    <>
      ...
      <main className="flex-1 px-3 pb-16 pt-4 sm:px-6 sm:pt-8">
        <h1 className="mx-auto mb-6 max-w-120 text-center text-2xl font-bold leading-tight text-white sm:text-3xl">
          Find the version of this stock you&rsquo;re actually allowed to hold
        </h1>

        <SwapCard />

        <p className="mx-auto mt-6 max-w-120 text-center text-xs leading-relaxed text-white/75">
